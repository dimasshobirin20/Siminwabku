 ...
 * @author dimas
 */
public class TabelTandatangan extends javax.swing.JFrame {

    /**
     * Creates new form TabelKuitansi
     */
    public TabelTandatangan() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tanggal", "No", "Kepada", "Nama", "Pkt/Nrp"
            }
        ));
    ...
    private void hapusBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusBtnActionPerformed
        try{ 
            String sql = "DELETE FROM `tandatangan` WHERE 0";
    ...
    private void lihatBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lihatBtnActionPerformed
        try{ 
            String sql = "SELECT * FROM tandatangan";
            Connection con = (Connection) Connect.getConnection();
            PreparedStatement pst = con.prepareStatement(sql);
            pst.execute();
        }catch(Exception e){
