 ...
 * @author dimas
 */
public class TabelKuitansi extends javax.swing.JFrame {

    /**
     * Creates new form TabelKuitansi
     */
    public TabelKuitansi() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tanggal", "No Bukti", "Mata Anggaran A", "Mata Anggaran B", "Terima Dari", "Uang A", "Uang B", "Pembayaran", "PPK", "Ka Kop", "Nama PPK", "Pangkat PPK", "Nama Ka Kop", "Pangkat Ka Kop", "Nama Pendaftar", "Pangkat Pendaftar"
            }
        ));
    ...
    private void kembaliBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kembaliBtnActionPerformed
        KuitansiBiasa kuitansiBiasa= new KuitansiBiasa();
        kuitansiBiasa.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_kembaliBtnActionPerformed

    private void hapusBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusBtnActionPerformed
        try{ 
            String sql = "DELETE FROM `kuitansi` WHERE 0";
